...
with gr.Blocks() as demo:
    ...
    output_text = gr.Textbox(label='번역결과', placeholder='번역된 결과가 여기에 표시됩니다.', interactive=False)

    translate_button.click(
        gradio_translate, inputs=[text_input, src_lang_dropdown, trg_lang_dropdown], outputs=output_text
    )
